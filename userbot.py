...
CHAT_API = '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'
...
async def answer(_, message):
    ...
    prompt="Представь, что живой человек  и напиши короткий осознанный комментарий на пост: " + message.text,
    temperature=0.9,
    max_tokens=2048,
    top_p=1,
    ...
    spam_posts = [TextPost(response['choices'][0]['text'])]
